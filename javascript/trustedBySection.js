...
toggleButton.addEventListener('click', function () {
    ...
    if (galleryExists) {
        ...
        toggleButton.textContent = 'Complete Client List'; // Change button text
    ...
    // Get the vertical position of the section relative to the top of the page
    const sectionPosition = section.getBoundingClientRect().top + window.scrollY;
    
    // Scroll to 30px above the section
    window.scrollTo({
        top: sectionPosition - 60,  // Adjust by -30px to scroll slightly above
